...
public class UserController {
    ...
    @GetMapping(value = "")
    public ResponseEntity<UserDTO> fetchMyProfile( @RequestHeader("X-UserId") String userId) {
        return new ResponseEntity<>(userMapper.toDTO(userService.getUserById(Long.valueOf(userId))), HttpStatus.OK);
    }
